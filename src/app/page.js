...
const VALID_USERNAME = "Gitaa";
const VALID_PASSWORD = "30012010";

const MASSAGES = [
  "Aku punya sesuatu yang spesial untukmu 💕",
  "Semoga suka ya, ini dari hati ✨",
  "Setiap halaman ini khusus untukmu, Gitaa 🌸",
...
export default function LandingPage() {
  ...
  const handleLogin = async (e) => {
    ...
    setTimeout(async () => {
      if (username.trim() === VALID_USERNAME && password === VALID_PASSWORD) {
        ...
        await showModal({
          title: "Selamat Datang, Gitaa! 🎉",
          message: "Semoga kamu suka hadiahnya ya~ 💕\nDibuat khusus dengan cinta untukmu.",
          type: "success",
  ...
  return (
    <section className="landing-section">
      ...
      <div className="landing-footer">Made with ♥ for Gitaa</div>
    </section>
  );
}
